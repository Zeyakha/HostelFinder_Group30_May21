...
<body onload="dataGetter('hostel_display')">
	...
	<div class="container-fluid" id="hostel_display">
		<%-- <div class="row">
			...
			<div class="col-md-6">
				<div class="row">
					<div class="col-md-4">
						<img src="<c:url value="resources/images/Girls.jpg" />"
							class="img-thumbnail" alt="Cinque Terre">
					</div>
					<div class="col-md-8" id="hos">
						<h1>Integral Girls Hostel</h1>
						<p>Common Room equipped with indoor game facilities.
							Playground and courts for outdoor games like Badminton,
							Volleyball, Cricket, Skating, Lawn Tennis, Basketball, etc.
							Gymnasium 24 Hrs. wi-fi Water Purifier Parking Guest Rooms
							Reading Room</p>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<a
					href="http://localhost:8080/HostelFinder/hosteldata/Integralgirlshostel.jsp">Know
					More</a>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="row">
					<div class="col-md-4">
						<img src="<c:url value="resources/images/Boys.JPG" />"
							class="img-thumbnail" alt="Cinque Terre">
					</div>
					<div class="col-md-8" id="hos">
			...
			<div class="col-md-3">
				<a
					href="http://localhost:8080/HostelFinder/hosteldata/Integralboyshostel.jsp">Know
					More</a>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<a
					href="http://localhost:8080/HostelFinder/hosteldata/awadhostel.jsp">Know
					More</a>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<a
					href="http://localhost:8080/HostelFinder/hosteldata/rajathostel.jsp">Know
					More</a>
			</div>
		</div> --%>
